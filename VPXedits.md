...
1. If the VPX table use a rom and controller feature is availble. Add the following into the VPX table Script. 
...
```Sub ACDC_Init
    ...
    End With
``
1. Options if the Table does not have a Rom. This can be Tricker. This is my solution for the goonies table Similar tables should have a similar solution. 
